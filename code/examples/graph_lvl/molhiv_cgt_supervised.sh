...
SEED="${1:-${SEED:-0}}"
PRETRAIN_CPT="${PRETRAIN_CPT:-./checkpoints/molhiv/pretrain_cgt_mini}"
OUTPUT_DIR="${OUTPUT_DIR:-./checkpoints/molhiv/finetune_cgt_mini_seed${SEED}}"
...
args=(
  "--config-name=experiments/molhiv_cgt_mini_finetune"
